...
import org.riversoft.salt.gui.service.SaltScriptCRUDService
...
@Slf4j
@RestController
class SaltScriptCRUDController extends BaseRestController {

    @Autowired
    SaltScriptCRUDService saltScriptGroupService
