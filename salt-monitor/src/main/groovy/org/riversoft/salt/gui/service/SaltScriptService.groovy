...
class SaltScriptService {
    ...
    @Autowired private SaltScriptRepository saltScriptRepository
    @Autowired private SaltScriptFileService saltScriptFileService
    @Autowired private SaltScriptGroupService saltScriptGroupService
    @Autowired private SaltScriptGroupRepository saltScriptGroupRepository
